    <div class="container top">
      ...
      <div class="page-header users-header">
        <h2>
          <?php echo 'The list of stock released';?> 
          <a  href="<?php echo site_url("admin").'/'.$this->uri->segment(2); ?>/add" class="btn btn-success">Add a new release</a>
        </h2>
      </div>
      ...
      <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            echo form_open('admin/release', $attributes);
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
                ...
                <th class="red header">Created</th>
            ...
            <tbody>
              ...
              foreach($products as $row)
              {
                ...
                echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/release/update/'.$row['id'].'" class="btn btn-info">view & edit</a>  
                  <a id="delete_id" onclick="confirmDeleteRelease('.$row['id'].')" class="btn btn-danger">delete</a>
                </td>';
                echo '</tr>';
              }
              ?>      
