    <div class="container top">
     ...
     <?php //echo '<span style="color:red">'.$delete.'</span>'; ?>
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
                ...
                <th class="yellow header headerSortDown">Mobile Phone</th>
            ...
            <tbody>
              ...
              foreach($manufacturers as $row)
              {
                echo '<tr>';
                echo '<td>'.$row['id'].'</td>';
                echo '<td><a href="'.site_url("admin").'/reports/'.$row['id'].'">'.$row['name'].'</a></td>';
                echo '<td>'.$row['phone'].'</td>';
                echo '<td>'.$row['address'].'</td>';
                echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/clients/update/'.$row['id'].'" class="btn btn-info">view & edit</a>  
                  <a id="delete" onclick="confirmDeleteClient('.$row['id'].')" class="btn btn-danger">delete</a>
                </td>';
                echo '</tr>';
              }
              ?>      
