...
/**
 * Admin_manufacturers class file.
 *
...
class Admin_manufacturers extends CI_Controller {
    ...
    */
    public function index()
    {
        ...
        if($search_string !== false && $order !== false || $this->uri->segment(3) == true){ 
            ...
            */
            ...
            //$data['not_deleted'] = 'Record not deleted';
        ...
        if(!$this->delete){
            $data['delete'] = 'Client not deleted because the he/she has stock';
        } else {
    ...
    public function add()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            $this->form_validation->set_rules('phone', 'Mobile No.', 'trim|required|min_length[8]|xss_clean');
            $this->form_validation->set_rules('address', 'Postal Adress', 'trim|required|xss_clean');
    ...
    */
    public function update()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            //form validation
            $this->form_validation->set_rules('name', 'name', 'trim|required|min_length[5]|xss_clean');
            $this->form_validation->set_rules('phone', 'Mobile No.', 'trim|required|min_length[10]|xss_clean');
            $this->form_validation->set_rules('address', 'Postal Adress', 'trim|required|xss_clean');
    ...
    */
    public function delete()
    {
        ...
        if(!$this->manufacturers_model->has_stock($id)){
